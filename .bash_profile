...
[[ -s "$HOME/.rvm/scripts/rvm" ]] && source "$HOME/.rvm/scripts/rvm" # Load RVM into a shell session *as a function* export PATH=/usr/local/openssl/bin:$PATH

##
# Your previous /Users/lukepearce/.bash_profile file was backed up as /Users/lukepearce/.bash_profile.macports-saved_2013-10-27_at_20:26:31
##

# MacPorts Installer addition on 2013-10-27_at_20:26:31: adding an appropriate PATH variable for use with MacPorts.
export PATH=/opt/local/bin:/opt/local/sbin:$PATH
